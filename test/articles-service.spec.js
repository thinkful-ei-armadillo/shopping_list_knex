...
//       return ArticleService.getAllArticles(db).then(actual => {
...
//       return ArticleService.getById(db, thirdId).then(actual => {
...
//     };
//     return ArticleService.insertArticle(db, newArticle).then(actual => {
//       expect(actual).to.eql({
//         id: 1,
